...
from CloudletSimulator.simulator.model.edge_server import MEC_server, cover_range_serch
import pandas as pd
import pickle
#CSV読み込み
...
for index, series in df.iterrows():
    ...
    device_flag, memo = cover_range_serch(device_flag, device_lon, device_lat, mec[index].lon, mec[index].lat, cover_range, index + 1)
    if memo > 0:
        tmp = memo
    print("**************")
